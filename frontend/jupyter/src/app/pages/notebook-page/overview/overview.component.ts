...
export class OverviewComponent implements OnDestroy {
  ...
  getPodDefaultsMessage(
    ...
    if (podRequestCompleted === true && configurations.length === 0) {
      return $localize`No configurations available for this notebook.`;
    }
  }
