  ...
  implements OnInit, OnDestroy, AfterContentChecked
{
  ...
  getEditNotebookDialogConfig(name: string, simpleDiff: Set<String>): DialogConfig {
    return {
      ...
      message: $localize`Warning: A running notebook server will automatically be restarted after being edited`,
  ...
  // returns only the parent fields from the diff results to be displayed a simple list the fields with differences
