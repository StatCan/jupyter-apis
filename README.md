...
| --- | --- | --- | --- |
| GET | /api/config | [/api/config](https://github.com/kubeflow/kubeflow/blob/v1.6.0/components/crud-web-apps/jupyter/backend/apps/common/routes/get.py#L9) | Gets the spawner_ui_config.yaml |
| GET | /api/gpus | [/api/gpus](https://github.com/kubeflow/kubeflow/blob/v1.6.0/components/crud-web-apps/jupyter/backend/apps/common/routes/get.py#L52) | Reads the GPU vendors from the spawner config |
| GET | /api/storageclasses |  |  |
...
| GET | /api/namespaces/{namespace}/notebooks/{notebook} | [/api/namespaces/\<namespace\>/notebooks/\<notebook\>](https://github.com/kubeflow/kubeflow/blob/cce5c88047815c45df8a52c8592e5890ae1b1949/components/crud-web-apps/jupyter/backend/apps/common/routes/get.py#L60) | Get a notebook |
| GET | /api/namespaces/{namespace}/notebooks/{notebook}/pod | [/api/namespaces/\<namespace\>/notebooks/\<notebook\>/pod](https://github.com/kubeflow/kubeflow/blob/cce5c88047815c45df8a52c8592e5890ae1b1949/components/crud-web-apps/jupyter/backend/apps/common/routes/get.py#LL64C4-L64C4) | Gets pod of notebook |
| GET | /api/namespaces/{namespace}/notebooks/{notebook}/pod/{pod_name}/logs | [/api/namespaces/\<namespace\>/notebooks/\<notebook\>/pod/\<pod_name\>/logs](https://github.com/kubeflow/kubeflow/blob/cce5c88047815c45df8a52c8592e5890ae1b1949/components/crud-web-apps/jupyter/backend/apps/common/routes/get.py#L81) | Gets logs of pod of notebook |
| GET | /api/namespaces/{namespace}/notebooks/{notebook}/events | [/api/namespaces/\<namespace\>/notebooks/\<notebook\>/events](https://github.com/kubeflow/kubeflow/blob/cce5c88047815c45df8a52c8592e5890ae1b1949/components/crud-web-apps/jupyter/backend/apps/common/routes/get.py#L90) | Gets events of notebook |
