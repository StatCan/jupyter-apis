describe('New notebook form', () => {
  ...
  describe('should validate every input', ()=>{
    it('notebook name', ()=>{
      ...
      cy.get('lib-name-input[resourcename="Notebook Server"]').find('input').should('have.class', 'ng-invalid');
      cy.get('lib-name-input[resourcename="Notebook Server"]').find('mat-error').should('have.text', "Name must consist of lowercase alphanumeric characters or '-\',\n    start with an alphabetic character, and end with an alphanumeric character.");
      cy.get('lib-name-input[resourcename="Notebook Server"]').find('input').clear();
      // name too long
      cy.get('lib-name-input[resourcename="Notebook Server"]').find('input').type('abcokkdoekdokjnf9nwerginrfmqnefqwfnniqfnwefijnrejfwnerjifmwermfjwmerifjmwierjmfwiermjfiwmerfjmwiremffwfwf');
      cy.get('lib-name-input[resourcename="Notebook Server"]').find('input').should('have.class', 'ng-invalid');
      cy.get('lib-name-input[resourcename="Notebook Server"]').find('mat-error').should('have.text', "Name is too long");
      cy.get('lib-name-input[resourcename="Notebook Server"]').find('input').clear();
      // name already used
      cy.get('lib-name-input[resourcename="Notebook Server"]').find('input').type('a-dog-breed-katib');
      cy.get('lib-name-input[resourcename="Notebook Server"]').find('input').should('have.class', 'ng-invalid');
      cy.get('lib-name-input[resourcename="Notebook Server"]').find('mat-error').should('have.text', 'Notebook Server "a-dog-breed-katib" already exists');
      cy.get('lib-name-input[resourcename="Notebook Server"]').find('input').clear();
      // name empty
      cy.get('lib-name-input[resourcename="Notebook Server"]').find('input').should('have.class', 'ng-invalid');
      cy.get('lib-name-input[resourcename="Notebook Server"]').find('mat-error').should('have.text', 'Name cannot be empty');
      // valid input
      cy.get('lib-name-input[resourcename="Notebook Server"]').find('input').type('test-new-notebook');
      cy.get('lib-name-input[resourcename="Notebook Server"]').find('input').should('have.class', 'ng-valid');
    });
    ...
    it('custom image', ()=>{
      ...
      // invalid pattern
      cy.get('[data-cy-form-input="customImage"]').find('input').type('http://abc.image:v1');
      cy.get('[data-cy-form-input="customImage"]').find('input').should('have.class', 'ng-invalid');
      cy.get('[data-cy-form-input="customImage"]').find('mat-error').should('have.text', 'http:// is not allowed in URLs');
      cy.get('[data-cy-form-input="customImage"]').find('input').clear();
      // empty input
      cy.get('[data-cy-form-input="customImage"]').find('input').should('have.class', 'ng-invalid');
      cy.get('[data-cy-form-input="customImage"]').find('mat-error').should('have.text', 'Custom image is required');
      cy.get('[data-cy-form-input="customImage"]').find('input').clear();
      // valid input
      cy.get('[data-cy-form-input="customImage"]').find('input').type('test/image:latest');
      cy.get('[data-cy-form-input="customImage"]').find('input').should('have.class', 'ng-valid');
    });
    ...
    it('minimum cpu', ()=>{
      ...
      cy.get('[data-cy-form-input="cpu"]').find('input').should('have.class', 'ng-invalid');
      cy.get('[data-cy-form-input="cpu"]').find('mat-error').should('have.text', 'Can\'t exceed 14 CPUs');
      cy.get('[data-cy-form-input="cpu"]').find('input').clear();
      // empty value
      cy.get('[data-cy-form-input="cpu"]').find('input').should('have.class', 'ng-invalid');
      cy.get('[data-cy-form-input="cpu"]').find('mat-error').should('have.text', 'Specify number of CPUs');
      // valid value
      cy.get('[data-cy-form-input="cpu"]').find('input').type('4');
      cy.get('[data-cy-form-input="cpu"]').find('input').should('have.class', 'ng-valid');
    });
    ...
    it('minimum memory', ()=>{
      ...
      cy.get('[data-cy-form-input="memory"]').find('input').should('have.class', 'ng-invalid');
      cy.get('[data-cy-form-input="memory"]').find('mat-error').should('have.text', 'Can\'t exceed 48Gi of memory');
      cy.get('[data-cy-form-input="memory"]').find('input').clear();
      // empty value
      cy.get('[data-cy-form-input="memory"]').find('input').should('have.class', 'ng-invalid');
      cy.get('[data-cy-form-input="memory"]').find('mat-error').should('have.text', 'Specify amount of memory (e.g. 2Gi)');
      // valid value
      cy.get('[data-cy-form-input="memory"]').find('input').type('4');
      cy.get('[data-cy-form-input="memory"]').find('input').should('have.class', 'ng-valid');
    });
    ...
    it('maximum cpu', ()=>{
      ...
      cy.get('[data-cy-form-input="cpuLimit"]').find('mat-error').should('have.text', 'Specify at least 0.5 CPUs');
      cy.get('[data-cy-form-input="cpuLimit"]').find('input').clear();
      // maximum value
      cy.get('[data-cy-form-input="cpuLimit"]').find('input').type('40.0');
      cy.get('[data-cy-form-input="cpuLimit"]').find('input').should('have.class', 'ng-invalid');
      cy.get('[data-cy-form-input="cpuLimit"]').find('mat-error').should('have.text', 'Can\'t exceed 14 CPUs');
      cy.get('[data-cy-form-input="cpuLimit"]').find('input').clear();
    ...
    it('maximum memory', ()=>{
      ...
      cy.get('[data-cy-form-input="memoryLimit"]').find('mat-error').should('have.text', 'Specify at least 1Gi of memory');
      cy.get('[data-cy-form-input="memoryLimit"]').find('input').clear();
      // maximum value
      cy.get('[data-cy-form-input="memoryLimit"]').find('input').type('90.0');
      cy.get('[data-cy-form-input="memoryLimit"]').find('input').should('have.class', 'ng-invalid');
      cy.get('[data-cy-form-input="memoryLimit"]').find('mat-error').should('have.text', 'Can\'t exceed 48Gi of memory');
      cy.get('[data-cy-form-input="memoryLimit"]').find('input').clear();
    ...
    it('workspace volume', ()=>{
      ...
      cy.get('[data-cy-form-input="workspaceVolume"]').find('[data-cy-form-input="volume-name"]').find('input').clear();
      // invalid pattern
      cy.get('[data-cy-form-input="workspaceVolume"]').find('[data-cy-form-input="volume-name"]').find('input').type('-volume-');
      cy.get('[data-cy-form-input="workspaceVolume"]').find('[data-cy-form-input="volume-name"]').find('input').should('have.class', 'ng-invalid');
      cy.get('[data-cy-form-input="workspaceVolume"]').find('[data-cy-form-input="volume-name"]').find('mat-error').should('have.text', ' The volume name can only contain lowercase alphanumeric characters,\n       \'-\' or \'.\', and must start and end with an alphanumeric character ');
      cy.get('[data-cy-form-input="workspaceVolume"]').find('[data-cy-form-input="volume-name"]').find('input').clear();
      // volume name in use
      cy.get('[data-cy-form-input="workspaceVolume"]').find('[data-cy-form-input="volume-name"]').find('input').type('dog-breed-nwmrc-tutorial-dog-breed-workspace-24ntl-jcjlv');
      cy.get('[data-cy-form-input="workspaceVolume"]').find('[data-cy-form-input="volume-name"]').find('input').should('have.class', 'ng-invalid');
      cy.get('[data-cy-form-input="workspaceVolume"]').find('[data-cy-form-input="volume-name"]').find('mat-error').should('have.text', ' Already mounted ');
      cy.get('[data-cy-form-input="workspaceVolume"]').find('[data-cy-form-input="volume-name"]').find('input').clear();
      // empty value
      cy.get('[data-cy-form-input="workspaceVolume"]').find('[data-cy-form-input="volume-name"]').find('input').should('have.class', 'ng-invalid');
      cy.get('[data-cy-form-input="workspaceVolume"]').find('[data-cy-form-input="volume-name"]').find('mat-error').should('have.text', ' Name is required ');
      // delete new volume
      cy.get('[data-cy-form-input="workspaceVolume"]').find('mat-icon[mattooltip="Delete volume"]').click();
      cy.get('[data-cy-form-input="workspaceVolume"] > mat-expansion-panel').should('not.exist');
      // add existing volume
      cy.get('[data-cy-form-button="workspaceVolume-new"]').should('exist');
      cy.get('[data-cy-form-button="workspaceVolume-existing"]').should('exist');
      cy.get('[data-cy-form-button="workspaceVolume-existing"]').click();
      cy.get('[data-cy-form-button="workspaceVolume-new"]').should('not.exist');
      cy.get('[data-cy-form-button="workspaceVolume-existing"]').should('not.exist');
      cy.get('[data-cy-form-input="workspaceVolume"] > mat-expansion-panel').find('app-existing-volume').should('exist');
      ...
      cy.get('[data-cy-form-input="workspaceVolume"]').find('[data-cy-form-input="existing-volume"]').should('have.class', 'ng-valid');
    });
    ...
    it('workspace volume auto update name', ()=>{
      ...
      cy.get('lib-name-input[resourcename="Notebook Server"]').find('input').type('test-notebook');
      cy.get('[data-cy-form-input="workspaceVolume"]').find('[data-cy-form-input="volume-name"]').find('input').invoke('val').should('eq', 'test-notebook-volume');
      // assert volume name doesn't auto update when dirty
      cy.get('[data-cy-form-input="workspaceVolume"]').find('[data-cy-form-input="volume-name"]').find('input').type('-dirty');
      cy.get('lib-name-input[resourcename="Notebook Server"]').find('input').type('-with-extra');
      cy.get('[data-cy-form-input="workspaceVolume"]').find('[data-cy-form-input="volume-name"]').find('input').invoke('val').should('eq', 'test-notebook-volume-dirty');
    });
    ...
    it('data volume', ()=>{
      ...
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="volume-name"]').find('input').should('have.class', 'ng-invalid');
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="volume-name"]').find('mat-error').should('have.text', ' The volume name can only contain lowercase alphanumeric characters,\n       \'-\' or \'.\', and must start and end with an alphanumeric character ');
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="volume-name"]').find('input').clear();
      // volume name in use
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="volume-name"]').find('input').type('dog-breed-nwmrc-tutorial-dog-breed-workspace-24ntl-jcjlv');
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="volume-name"]').find('input').should('have.class', 'ng-invalid');
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="volume-name"]').find('mat-error').should('have.text', ' Already mounted ');
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="volume-name"]').find('input').clear();
      // empty value
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="volume-name"]').find('input').should('have.class', 'ng-invalid');
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="volume-name"]').find('mat-error').should('have.text', ' Name is required ');
      // mount path invalid pattern
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="mount-path"]').find('input').clear();
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="mount-path"]').find('input').type('abc/');
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="mount-path"]').find('input').should('have.class', 'ng-invalid');
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="mount-path"]').find('mat-error').should('have.text', ' The accepted locations are /home/jovyan, /opt/openmpp and any of their subdirectorie ');
      // mount path empty value
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="mount-path"]').find('input').clear();
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="mount-path"]').find('input').should('have.class', 'ng-invalid');
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="mount-path"]').find('mat-error').should('have.text', ' Mount path is required ');
      ...
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="mount-path"]').eq(1).find('mat-error').should('have.text', ' This mount path is already in use ');
      // delete new volumes
      // deletes the first data volume in the list, then deletes the last remaining data volume
      cy.get('[data-cy-form-input="dataVolumes"]').find('mat-icon[mattooltip="Delete volume"]').eq(0).click();
      cy.get('[data-cy-form-input="dataVolumes"]').find('mat-icon[mattooltip="Delete volume"]').click();
      ...
      cy.get('[data-cy-form-input="dataVolumes"] > mat-expansion-panel').find('app-existing-volume').should('exist');
      // existing volume name empty
      cy.get('[data-cy-form-input="dataVolumes"] > mat-expansion-panel').click();
      ...
      cy.get('[data-cy-form-input="prob"]').click();
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="existing-volume"]').should('have.class', 'ng-valid');
    });
    ...
    it('data volume auto update name', ()=>{
      ...
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="mount-path"]').find('input').invoke('val').should('eq', '/home/jovyan/test-notebook-datavol-1');
      // assert volume name doesn't auto update when dirty
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="volume-name"]').find('input').type('-dirty');
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="mount-path"]').find('input').invoke('val').should('eq', '/home/jovyan/test-notebook-datavol-1-dirty');
      cy.get('[data-cy-form-input="dataVolumes"]').find('[data-cy-form-input="mount-path"]').find('input').type('-mount');
      cy.get('lib-name-input[resourcename="Notebook Server"]').find('input').type('-with-extra');
